...
export var createBroker = function (brokerImplementation) {
    ...
    return function (sender) {
        ...
        var functions = {};
        for (var _i = 0, _a = Object.entries(fullBrokerImplementation); _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], handler = _b[1];
            functions = tslib_1.__assign({}, functions, (_c = {}, _c[key] = handler({ call: call, notify: notify }), _c));
        }
